...
const HomePage: React.FC = () => {
    ...
    return (
        <div className="overflow-x-hidden">
            {/* ── HERO (2-column · Mtato/Homearia style) ───────── */}
            <section className="relative min-h-[88vh] flex items-center bg-mesh overflow-hidden">
                {/* decorative blobs */}
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_1fr] gap-12 lg:gap-16 items-center">
                        ...
                        <div className="text-left max-w-xl">
                            <motion.div initial="hidden" animate="visible" variants={fadeUp} custom={0}>
                                <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary-50 border border-primary-100 text-primary-700 text-xs font-bold uppercase tracking-widest mb-6">
                            ...
                            <motion.h1
                                ...
                                variants={fadeUp}
                                custom={0.08}
                                className="text-4xl sm:text-5xl lg:text-6xl font-black text-slate-900 tracking-tight leading-[1.08] mb-5"
                            >
                                Find your next home
                                <br />
                            ...
                            >
                                Browse verified listings, connect with landlords instantly, and move
                                into a place that truly fits your life.
                            </motion.p>
                            ...
                            >
                                {['Verified listings', 'Instant booking', 'Secure payments', 'No hidden fees'].map((tag) => (
                                    <span
                                        key={tag}
                                        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white border border-slate-200 text-xs font-semibold text-slate-600 shadow-sm"
                                    >
                            ...
                            <motion.div
                                ...
                                variants={fadeUp}
                                custom={0.38}
                                className="mt-10 flex flex-wrap items-center gap-x-6 gap-y-2 text-xs text-slate-400 font-medium uppercase tracking-wider"
                            >
                                <span>Trusted by students from</span>
                                <span className="text-slate-500 font-semibold">BZU</span>
                                <span className="text-slate-500 font-semibold">UCP Multan</span>
                                <span className="text-slate-500 font-semibold">NFC IET</span>
                                <span className="text-slate-500 font-semibold">Air University</span>
                            </motion.div>
                        </div>
                        ...
                        >
                            ...
                            <div className="relative rounded-3xl overflow-hidden shadow-2xl bg-gradient-to-br from-primary-100 to-primary-50 aspect-[4/5]">
                                ...
                                <div className="absolute bottom-5 left-5 right-5 bg-white/95 backdrop-blur rounded-2xl p-4 shadow-lg">
                                    <div className="flex items-center justify-between mb-2">
                                        <div>
                                            <p className="text-xs text-slate-500 font-semibold flex items-center gap-1">
                                                <MapPin className="w-3 h-3" /> DHA Phase 1, Multan
                                            </p>
                                    ...
                                    <div className="flex gap-1.5">
                                        {['2 Bed', '1 Bath', 'WiFi'].map((t) => (
                                            <span
                                                key={t}
                                                className="px-2 py-0.5 bg-slate-100 text-slate-600 text-[10px] font-semibold rounded"
                                            >
                                                {t}
                                            </span>
                                        ))}
                            ...
                            {/* Floating compatibility chip (top-right) */}
                            <motion.div
                                initial={{ opacity: 0, x: 30 }}
                                animate={{ opacity: 1, x: 0, transition: { delay: 0.6, duration: 0.6 } }}
                                className="absolute -top-3 -right-3 bg-white rounded-2xl shadow-xl border border-slate-100 p-3 flex items-center gap-3"
                            >
                                <div className="h-10 w-10 rounded-full bg-emerald-100 flex items-center justify-center">
                                    <span className="text-emerald-700 font-black text-sm">92%</span>
                                </div>
                                <div>
                                    <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400">
                                        Compatibility
                                    </p>
                                    <p className="text-xs font-bold text-slate-900">Best match</p>
                                </div>
                            </motion.div>
                            ...
                            <motion.div
                                ...
                                className="absolute -bottom-4 -left-4 bg-white rounded-2xl shadow-xl border border-slate-100 px-5 py-4"
                            >
